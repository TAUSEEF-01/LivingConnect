...
// Add these near the top of the file, after other middleware
app.use(
  cors({
    origin: "*",
...
// Move this before routes registration
app.use(express.json({ limit: "50mb" }));
app.use(express.urlencoded({ extended: true, limit: "50mb" }));

// Register the houseDetails routes first
const houseDetailsRoutes = require("./routes/houseDetails");
app.use("/houseDetails", houseDetailsRoutes);
