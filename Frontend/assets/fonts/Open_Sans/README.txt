...
-------------------------------
  ...
  http://developers.google.com/web/fundamentals/design-and-ux/typography/variable-fonts
  http://variablefonts.typenetwork.com
  http://medium.com/variable-fonts

In desktop apps

  http://theblog.adobe.com/can-variable-fonts-illustrator-cc
  http://helpx.adobe.com/nz/photoshop/using/fonts.html#variable_fonts

Online

  http://developers.google.com/fonts/docs/getting_started
  http://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Fonts/Variable_Fonts_Guide
  http://developer.microsoft.com/en-us/microsoft-edge/testdrive/demos/variable-fonts

Installing fonts

  MacOS: http://support.apple.com/en-us/HT201749
  Linux: http://www.google.com/search?q=how+to+install+a+font+on+gnu%2Blinux
  Windows: http://support.microsoft.com/en-us/help/314960/how-to-install-or-remove-a-font-in-windows

Android Apps

  http://developers.google.com/fonts/docs/android
  http://developer.android.com/guide/topics/ui/look-and-feel/downloadable-fonts
