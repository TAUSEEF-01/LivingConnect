...
const HomeDetailsPage = () => {
  ...
  // useEffect(() => {
    // if (!ownerInfo) {
    //   console.error('ownerInfo is undefined');
    //   return;
    // }
  ...
  // if (!ownerInfo) {
  //   return <Text>Loading...</Text>; // Or any other fallback UI
  // }
  ...
  const fetchHomeDetails = async () => {
    try {
      ...
      const response = await axios.get(
        ...
        `http://192.168.0.109:5000/houseDetails/get-homes-details/${homeId}`
