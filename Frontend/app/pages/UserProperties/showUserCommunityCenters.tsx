...
// //           }
// //         >
// //           <Text style={styles.title}>{index + 1}. My Community Center </Text>
...
//               <Text style={styles.cardTitle}>Community Center {index + 1}</Text>
...
const AllHomesPage = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.headerContainer}>
        <Text style={styles.headerTitle}>My Community Centers</Text>
                <Text style={styles.headerSubtitle}>Manage Your Listed Community Centers</Text>
      </View>
