...
//       const response = await fetch('http://192.168.0.103:5000/home-details', {
//         method: 'POST',
//         headers: {
...
const HomeDetailsForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // const response1 = await fetch("http://192.168.0.103:5000/home-details", {
      //   method: "POST",
      //   headers: {
      //     // "Content-Type": "application/json"
      ...
      const response = await axios.post(
        "http://192.168.0.103:5000/houseDetails/home-details",
        // "http://192.168.0.103:5000/houseDetails/home-details",
        formData,
        {
          headers: {
