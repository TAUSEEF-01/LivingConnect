...
//         "http://192.168.0.103:5000/houseDetails/successFalse" // Replace with your API endpoint
//       );
...
//   //   try {
//   //     await axios.patch(
//   //       `http://192.168.0.103:5000/forms/approve/${formId}` // Replace with your API endpoint
//   //     );
...
//   //   try {
//   //     await axios.delete(
//   //       `http://192.168.0.103:5000/forms/reject/${formId}` // Replace with your API endpoint
//   //     );
...
const AdminApprovalPage = () => {
  ...
  const fetchSuccessTrue = async () => {
    try {
      const response = await axios.get(
        "http://192.168.0.103:5000/houseDetails/successTrue" // Replace with your API endpoint
      );
      setForms(response.data);
    } catch (error) {
      Alert.alert("Error", "Failed to fetch form details.");
