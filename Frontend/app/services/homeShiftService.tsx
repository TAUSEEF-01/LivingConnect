  ...
  const fetchAllHomeDetails = async () => {
    try {
      ...
      const response = await axios.get(
        "https://livingconnect-backend.vercel.app/serviceDetails/get-all-service-details-houseShift-otherUsers",
        {
          headers: {
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.banner}>
          ...
          <View style={styles.bannerImageContainer}>
            <Image
              source={require("../../assets/images/shift-page.jpg")}
              // source={{
          ...
          <ScrollView style={styles.scrollContainer}>
            {homes.map((home) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push({
                    pathname: "/services/homeShiftpage",
