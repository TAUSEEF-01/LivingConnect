...
const EditHomeDetails = () => {
    ...
    const fetchHomeDetails = async () => {
      try {
        ...
        const response = await axios.get(
          `https://livingconnect-backend.vercel.app/serviceDetails/get-all-service-details/${id}`
        );
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = `https://livingconnect-backend.vercel.app/serviceDetails/update-service/${id}`;
      ...
      Alert.alert("Error", `Failed to update service details: ${errorMessage}`);
    }
  };
